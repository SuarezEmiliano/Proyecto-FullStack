...
import PlataformasListado from "./PlataformasListado";
import PlataformasBuscar from "./PlataformasBuscar";
import PlataformaRegistro from "./PlataformasRegistro";
...
function Plataformas() {
    ...
    async function Buscar(_pagina) {
        ...
        const data = await plataformasService.Buscar(Nombre, _pagina);
        setItems(data.Items);
    ...
    return (
        <div>
            ...
            {AccionABMC === "L" &&  <PlataformasBuscar
                Nombre={Nombre}
                setNombre={setNombre}
                Buscar={Buscar}
                Agregar={Agregar}
            ...
            {AccionABMC === "L" && Items?.length > 0 && <PlataformasListado
                {...{
                    Items,
                    Consultar,
                    Modificar,
            ...
            {AccionABMC !== "L" && <PlataformaRegistro
                {...{ AccionABMC,  
                    Item, 
                    Grabar, 
                    Volver 
